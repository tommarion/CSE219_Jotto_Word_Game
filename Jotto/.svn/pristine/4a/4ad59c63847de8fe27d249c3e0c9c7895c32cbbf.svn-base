...
/**
 * The JottoGUI contains all user interface components and maintains
...
{   
    /**
     * The JottoUIState represents the four screen states that are
     * possible for the Jotto game application. Depending on which
     ...
     */
    public JottoGameStateManager    getGSM()            {   return gsm;     }
     ...
     */
    public JottoErrorHandler        getErrorHandler()   { return errorHandler;  }
     ...
     */
    public JottoDocumentManager     getDocManager()     { return docManager; }
    ...
    /**
     * This method will provide access to the current color
     * for a given letter.
     * 
    ...
    private void initNorthToolbar()
    {
        ...
        // MAKE AND INIT THE HOME BUTTON
        homeButton = initToolbarButton(northToolbar, JottoPropertyType.HOME_IMG_NAME);
     ...
     * use of the JottoFileLoader utility class to do so.
     * 
    ...
    /**
     * This function clears the guess text field after the user makes a 
     * guess as a convenience to the user.
     */
