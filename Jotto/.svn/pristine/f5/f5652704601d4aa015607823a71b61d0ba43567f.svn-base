...
public class JottoEventHandler
{
    ...
    /**
     * This method responds to when the user presses one of the
     * letter buttons, which toggles letter coloring.
     * 
     * @param source The JButton that was pressed by the user. We
     * respond by changing its color.
     */
    public void respondToToggleLetterButtonRequest(Object source)
    {
        ...
        // AND TOGGLE IT'S TEXT AND BACKGROUND COLORS
        ...
        ui.getDocManager().updateGuessColor();
    }
     ...
     * 
     * @param guessTextField The text field where the user typed
     * a guess and then pressed enter.
     */
    public void respondToGuessWordRequest(JTextField guessTextField)
    {
        ...
        try
        {
            ...
            //commented for test-handling
            //Only accepts a guess if it's exactly 5 letters and is a word
        ...
        {
            ui.getErrorHandler().processError(JottoPropertyType.INVALID_GUESS_ERROR_TEXT);
        }
    }
